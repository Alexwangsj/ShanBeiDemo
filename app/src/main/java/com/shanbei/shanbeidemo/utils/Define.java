...
public class Define {
    public final static String article = "KIEV — The European Union warned Ukraine on Thursday time was running out to revive shelved deals on free trade and political association by meeting the bloc'sconcerns over the jailing of opposition leader Yulia Tymoshenko and bringing inreforms.\n" +
            ...
            "\"It would also not be able any more to regulate areas such as food standards, or technical product standards, all of them important in the framework of the DCFTA. It will not be able to integrate economically with the European Union,\" he continued.\n" +
    ...
    public static class WordTranslateInfo{
        public String content;     //单词
        public String soundMark;   //音标
        public String definition;  //中文释义
